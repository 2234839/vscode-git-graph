 ...
 * 常量定义模块
 *
 * 从原 web/utils.ts 中的常量提取，供各模块共享使用。
 */
...
export const GIT_FILE_CHANGE_TYPES: Record<string, string> = { 'A': 'Added', 'M': 'Modified', 'D': 'Deleted', 'R': 'Renamed', 'U': 'Untracked' };
export const GIT_SIGNATURE_STATUS_DESCRIPTIONS: Record<string, string> = {
	'G': 'Valid Signature',
