...
export let activeLanguage: Language = 'zh';
...
export const STRINGS: Record<string, Entry> = {
  ...
  branchCheckedOutAtCommit: {
    zh: '分支 {0} 当前已检出至此提交',
    en: 'Branch {0} is currently checked out at this commit',
  },
  commitCheckedOut: { zh: '此提交当前已检出', en: 'This commit is currently checked out' },

  // === Dialog ===
  invalidInput: {
    zh: '无法{0}，输入了一个或多个无效字符。',
    en: 'Unable to {0}, one or more invalid characters were entered.',
  },
  errorPrefix: { zh: '错误：', en: 'Error: ' },
  compareBranch: { zh: '比较分支', en: 'Compare Branch' },
  noBranchesToCompare: {
    zh: '没有其他本地分支可比较。',
    en: 'There are no other local branches to compare with.',
  },
  selectBranchToCompare: {
    zh: '选择要比较的分支 {0}：',
    en: 'Select a branch to compare with {0}:',
  },
  compareBtn: { zh: '比较', en: 'Compare' },
  compareBranchNotFound: {
    zh: '在当前视图中找不到所选分支的提交。请尝试加载更多提交。',
    en: 'The commits of the selected branch could not be found in the current view. Please try loading more commits.',
  },
  ...
  confirmDeleteBranch: {
    zh: '确定要删除分支 {0} 吗？',
    en: 'Are you sure you want to delete branch {0}?',
  },
  ...
  confirmPushBranch: {
    zh: '确定要推送分支 {0} 到远程 {1} 吗？',
    en: 'Are you sure you want to push branch {0} to remote {1}?',
  },
  confirmPushBranchMulti: {
    zh: '确定要推送分支 {0} 吗？',
    en: 'Are you sure you want to push branch {0}?',
  },
  ...
  confirmUpdateLocal: {
    zh: '确定要用 {0} 的最新更改更新本地分支 {1} 吗？',
    en: 'Are you sure you want to update the local branch {1} with the latest changes from {0}?',
  },
  ...
  confirmCreatePR: {
    zh: '确定要为分支 {0} 创建 Pull Request 吗？',
    en: 'Are you sure you want to create a Pull Request for branch {0}?',
  },
  pushBeforePR: {
    zh: '创建 Pull Request 前先推送分支',
    en: 'Push branch before creating Pull Request',
  },
  ...
  unselectInBranchesDropdown: {
    zh: '在分支下拉菜单中取消选中',
    en: 'Unselect in Branches Dropdown',
  },
  ...
  confirmCheckoutCommit: {
    zh: "确定要检出提交 {0} 吗？这将导致'分离头指针（detached HEAD）'状态。",
    en: "Are you sure you want to checkout commit {0}? This will result in a 'detached HEAD' state.",
  },
  ...
  confirmCherryPick: {
    zh: '确定要拣选提交 {0} 吗？',
    en: 'Are you sure you want to cherry pick commit {0}?',
  },
  yesCherryPick: { zh: '是，拣选', en: 'Yes, Cherry Pick' },
  cherryPickingCommit: { zh: '正在拣选提交', en: 'Cherry Picking Commit' },
  revert: { zh: '还原', en: 'Revert' },
  confirmRevertMerge: {
    zh: '确定要还原合并提交 {0} 吗？选择主分支上的父提交哈希，以相对于该提交进行还原：',
    en: 'Are you sure you want to revert merge commit {0}? Select the parent commit hash on the main branch to revert relative to:',
  },
  yesRevert: { zh: '是，还原', en: 'Yes, Revert' },
  revertingCommit: { zh: '正在还原提交', en: 'Reverting Commit' },
  confirmRevertCommit: {
    zh: '确定要还原提交 {0} 吗？',
    en: 'Are you sure you want to revert commit {0}?',
  },
  undoLastCommit: { zh: '重置上次提交（软重置）', en: 'Undo Last Commit (Soft Reset)' },
  confirmUndoLast: {
    zh: '确定要重置上次提交吗？这会将提交的所有更改保留为未提交的更改。',
    en: 'Are you sure you want to undo the last commit? This will keep all changes of the commit as uncommitted changes.',
  },
  ...
  confirmDropCommit: {
    zh: '确定要永久丢弃提交 {0} 吗？',
    en: 'Are you sure you want to permanently drop commit {0}?',
  },
  dropCommitWarning: {
    zh: '注意：启用"仅跟踪提交的第一个父提交"后，可能会有一些提交从 Git Graph 视图中隐藏，这可能会影响执行此操作的结果。',
    en: 'Note: Enabling "Only Follow the First Parent of Commits" may hide some commits from the Git Graph View, which could affect the outcome of this action.',
  },
  yesDrop: { zh: '是，丢弃', en: 'Yes, Drop' },
  droppingCommit: { zh: '正在丢弃提交', en: 'Dropping Commit' },
  rebaseCurrentOntoCommit: {
    zh: '将当前分支变基到此提交',
    en: 'Rebase Current Branch onto this Commit',
  },
  resetCurrentToCommit: { zh: '将当前分支重置到此提交', en: 'Reset Current Branch to this Commit' },
  confirmResetToCommit: {
    zh: '确定要将{0}重置到提交 {1} 吗？',
    en: 'Are you sure you want to reset {0} to commit {1}?',
  },
  currentBranchLabel: { zh: '当前分支', en: 'the current branch' },
  resetSoft: {
    zh: '软 - 保留所有更改，但重置 HEAD',
    en: 'Soft - Keep all changes, but reset HEAD',
  },
  resetMixed: {
    zh: '混合 - 保留工作区，但重置索引',
    en: 'Mixed - Keep the working tree, but reset the index',
  },
  ...
  confirmDeleteRemoteBranch: {
    zh: '确定要删除远程分支 {0} 吗？',
    en: 'Are you sure you want to delete the remote branch {0}?',
  },
  ...
  confirmFetchIntoLocal: {
    zh: '确定要将远程分支 {0} 获取到本地分支 {1} 吗？',
    en: 'Are you sure you want to fetch the remote branch {0} into local branch {1}?',
  },
  forceFetch: { zh: '强制获取', en: 'Force Fetch' },
  yesFetch: { zh: '是，获取', en: 'Yes, Fetch' },
  fetchingBranch: { zh: '正在获取分支', en: 'Fetching Branch' },
  confirmPullRemote: {
    zh: '确定要将远程分支 {0} 拉取到{1}吗？如果需要合并：',
    en: 'Are you sure you want to pull the remote branch {0} into {1}? If a merge is required:',
  },
  createNewCommitEvenFF: {
    zh: '即使可以快进也创建新提交',
    en: 'Create a new commit even if fast-forward is possible',
  },
  ...
  confirmApplyStash: {
    zh: '确定要应用储藏 {0} 吗？',
    en: 'Are you sure you want to apply stash {0}?',
  },
  ...
  createBranchFromStashMsg: {
    zh: '从储藏 {0} 创建分支，名称为：',
    en: 'Create a branch from stash {0}, with name:',
  },
  ...
  confirmDropStash: {
    zh: '确定要丢弃储藏 {0} 吗？',
    en: 'Are you sure you want to drop stash {0}?',
  },
  ...
  confirmDeleteTag: {
    zh: '确定要删除标签 {0} 吗？',
    en: 'Are you sure you want to delete tag {0}?',
  },
  dontDeleteAnyRemote: { zh: '不在任何远程上删除', en: "Don't delete on any remote" },
  alsoDeleteOnRemoteQ: {
    zh: '是否还要在远程上删除此标签：',
    en: 'Would you also like to delete it on a remote:',
  },
  alsoDeleteOnRemote: { zh: '同时在远程删除', en: 'Also delete on remote' },
  pushTag: { zh: '推送标签', en: 'Push Tag' },
  confirmPushTag: {
    zh: '确定要将标签 {0} 推送到远程 {1} 吗？',
    en: 'Are you sure you want to push tag {0} to remote {1}?',
  },
  confirmPushTagMulti: {
    zh: '确定要推送标签 {0} 吗？选择要推送标签到的远程：',
    en: 'Are you sure you want to push tag {0}? Select the remotes you want to push the tag to:',
  },
  ...
  confirmStashUncommitted: {
    zh: '确定要储藏<b>未提交的更改</b>吗？',
    en: 'Are you sure you want to stash the <b>uncommitted changes</b>?',
  },
  ...
  confirmResetUncommitted: {
    zh: '确定要将<b>未提交的更改</b>重置为 <b>HEAD</b> 吗？',
    en: 'Are you sure you want to reset the <b>uncommitted changes</b> to <b>HEAD</b>?',
  },
  resettingUncommitted: { zh: '正在重置未提交的更改', en: 'Resetting Uncommitted Changes' },
  cleanUntracked: { zh: '清理未跟踪文件', en: 'Clean Untracked Files' },
  confirmCleanUntracked: {
    zh: '确定要清理所有未跟踪文件吗？',
    en: 'Are you sure you want to clean all untracked files?',
  },
  ...
  selectIssueToView: {
    zh: '选择要查看的此分支的 Issue：',
    en: 'Select an Issue of this branch to view:',
  },
  ...
  tagExists: {
    zh: '名为 {0} 的标签已存在，是否要用此新标签替换它？',
    en: 'Tag {0} already exists. Would you like to replace it with this new tag?',
  },
  ...
  branchExists: {
    zh: '名为 {0} 的分支已存在，是否要用此新分支替换它？',
    en: 'Branch {0} already exists. Would you like to replace it with this new branch?',
  },
  ...
  confirmMerge: {
    zh: '确定要将 {0} {1} 合并到{2}吗？',
    en: 'Are you sure you want to merge the {0} {1} into {2}?',
  },
  yesMerge: { zh: '是，合并', en: 'Yes, Merge' },
  confirmRebase: {
    zh: '确定要将{0}变基到 {1} {2} 吗？',
    en: 'Are you sure you want to rebase {0} onto the {1} {2}?',
  },
  yesRebase: { zh: '是，变基', en: 'Yes, Rebase' },

  // === Checkout branch dialog ===
  checkoutNewBranchName: {
    zh: '检出 {0} 时要创建的新分支名称：',
    en: 'Enter the name of the new branch to create when checking out {0}:',
  },
  nameUsedByBranch: {
    zh: '名称 {0} 已被另一个分支使用：',
    en: 'The name {0} is already used by another branch:',
  },
  chooseAnotherName: { zh: '选择另一个分支名', en: 'Choose a different branch name' },
  checkoutExisting: { zh: '检出已有分支', en: 'Checkout Existing Branch' },
  checkoutExistingAndPull: {
    zh: '检出已有分支并拉取更改',
    en: 'Checkout Existing Branch & Pull Changes',
  },
  checkingOutBranch: { zh: '正在检出分支', en: 'Checking Out Branch' },
  checkingOutBranchAndPull: {
    zh: '正在检出分支并拉取更改',
    en: 'Checking Out Branch & Pulling Changes',
  },
  ...
  unableLoadRepoView: {
    zh: '无法为仓库 "{0}" 加载 Git Graph 视图。它当前未包含在 Git Graph 中。',
    en: 'Unable to load the Git Graph View for repository "{0}". It is not currently included in Git Graph.',
  },
  ...
  codeReviewNotFound: {
    zh: '无法恢复代码审查，在此仓库最近加载的 {0} 个提交中未找到。',
    en: 'Unable to restore the code review, as it was not found within the most recent {0} commits loaded in this repository.',
  },
  ...
  openMatchInCdv: {
    zh: '为当前匹配项打开提交详情视图',
    en: 'Open the Commit Details View for the current match',
  },
  closeEscape: { zh: '关闭 (Escape)', en: 'Close (Escape)' },
  regexZeroLength: {
    zh: '不能使用会产生零长度匹配的正则表达式',
    en: 'Cannot use a regular expression that yields zero-length matches.',
  },
  ...
  settingsDefaultNameFromFs: {
    zh: '（来自文件系统的默认名称）',
    en: ' (default name from file system)',
  },
  ...
  settingsIncludeReflog: {
    zh: '包含仅在 reflog 中提及的提交',
    en: 'Include commits only mentioned by reflogs',
  },
  settingsIncludeReflogInfo: {
    zh: '仅在显示所有分支时适用。',
    en: 'Only applicable when all branches are being displayed.',
  },
  settingsOnlyFirstParent: {
    zh: '仅跟随提交的第一个父提交',
    en: 'Only Follow the First Parent of Commits',
  },
  settingsOnlyFirstParentInfo: {
    zh: '在发现要加载的提交时，仅跟随第一个父提交，而不是跟随所有父提交。',
    en: 'Only follow the first parent of commits when discovering commits to load, instead of following all parents.',
  },
  ...
  settingsUserDetailsDesc: {
    zh: '用户详情（如姓名和邮箱）被 Git 用于记录提交对象的作者和提交者。',
    en: 'User Details (such as name and email) are used by Git to record the author and committer of commit objects.',
  },
  ...
  settingsNoRemotes: {
    zh: '此仓库未配置任何远程仓库。',
    en: 'There are no remote repositories configured for this repository.',
  },
  settingsAddRemote: { zh: '添加远程仓库', en: 'Add Remote' },
  settingsClickToShow: {
    zh: '点击显示此远程仓库的分支。',
    en: "Click to show this remote's branches.",
  },
  settingsClickToHide: {
    zh: '点击隐藏此远程仓库的分支。',
    en: "Click to hide this remote's branches.",
  },
  ...
  settingsIssueLinkingDesc: {
    zh: 'Issue 链接将提交和标签消息中的 Issue 编号转换为超链接，点击可在您的 Issue 跟踪系统中打开该 Issue。如果分支名称包含 Issue 编号，可通过分支的右键菜单查看该 Issue。',
    en: "Issue Linking transforms issue numbers in commit and tag messages into hyperlinks that open the issue in your issue tracker. If a branch name contains an issue number, the issue can be viewed via the branch's context menu.",
  },
  settingsEditIssueLinking: {
    zh: '编辑此仓库的 Issue 链接',
    en: 'Edit the Issue Linking for this repository',
  },
  settingsAddIssueLinkingToRepo: {
    zh: '为此仓库添加 Issue 链接',
    en: 'Add Issue Linking to this repository',
  },
  ...
  settingsConfigurePR: {
    zh: '配置"Pull Request 创建"集成',
    en: 'Configure "Pull Request Creation" Integration',
  },
  settingsPRDesc: {
    zh: 'Pull Request 创建功能可自动从分支的右键菜单中打开并预填 Pull Request 表单。',
    en: "Pull Request Creation can automatically open and pre-fill a Pull Request form from a branch's context menu.",
  },
  settingsGitGraphConfig: { zh: 'Git Graph 配置', en: 'Git Graph Configuration' },
  settingsOpenExtSettings: {
    zh: '打开 Git Graph 扩展设置',
    en: 'Open Git Graph Extension Settings',
  },
  ...
  confirmDeleteRepoName: {
    zh: '确定要删除此仓库手动配置的名称 {0}，并使用文件系统中的默认名称 {1} 吗？',
    en: 'Are you sure you want to delete the manually configured name {0} of this repository, and use the default name from the file system {1}?',
  },
  configureInitialBranches: { zh: '配置初始分支', en: 'Configure Initial Branches' },
  configureInitialBranchesDesc: {
    zh: '配置在此仓库加载到 Git Graph 视图时初始显示的分支。',
    en: 'Configure the branches that are initially displayed when this repository is loaded into the Git Graph View.',
  },
  configureInitialBranchesNote: {
    zh: '注意：当"已检出分支"被禁用，且未选择任何"特定分支"时，将显示所有分支。',
    en: 'Note: When "Checked Out Branches" is disabled, and no "Specific Branches" are selected, all branches will be displayed.',
  },
  ...
  confirmClearInitialBranches: {
    zh: '确定要清除在此仓库加载到 Git Graph 视图时初始显示的分支吗？',
    en: 'Are you sure you want to clear the branches that are initially displayed when this repository is loaded into the Git Graph View?',
  },
  yesClear: { zh: '是，清除', en: 'Yes, Clear' },
  setUserDetailsDesc: {
    zh: '设置 Git 用于记录提交对象作者和提交者的用户名和邮箱：',
    en: 'Set the user name and email that Git will use to record the author and committer of commit objects:',
  },
  userName: { zh: '用户名', en: 'User Name' },
  userEmail: { zh: '用户邮箱', en: 'User Email' },
  useGlobally: { zh: '全局使用', en: 'Use Globally' },
  useGloballyInfo: {
    zh: '对所有 Git 仓库全局使用此"用户名"和"用户邮箱"（可按仓库覆盖）。',
    en: 'Use this "User Name" and "User Email" globally for all Git repositories (can be overridden per repository).',
  },
  setUserDetails: { zh: '设置用户详情', en: 'Set User Details' },
  confirmRemoveUserDetails: {
    zh: '确定要移除{0}配置的</b>用户名和邮箱吗？这些信息被 Git 用于记录提交对象的作者和提交者。',
    en: 'Are you sure you want to remove the<b>{0} configured</b> user name and email? These are used by Git to record the author and committer of commit objects.',
  },
  ...
  addNewRemote: {
    zh: '为此仓库添加新的远程仓库：',
    en: 'Add a new remote repository to this repository:',
  },
  ...
  confirmDeleteRemote: {
    zh: '确定要删除远程仓库 {0} 吗？',
    en: 'Are you sure you want to delete the remote repository {0}?',
  },
  confirmFetchFromRemote: {
    zh: '确定要从远程仓库 {0} 获取吗？',
    en: 'Are you sure you want to fetch from the remote repository {0}?',
  },
  prune: { zh: '清理', en: 'Prune' },
  pruneInfo: {
    zh: '获取前，移除远程仓库上已不存在的远程跟踪引用。',
    en: 'Remove any remote-tracking references that no longer exist on the remote repository, before fetching.',
  },
  pruneTags: { zh: '清理标签', en: 'Prune Tags' },
  pruneTagsInfo: {
    zh: '获取前，移除远程仓库上已不存在的本地标签。需要 Git >= 2.17.0，且启用"清理"。',
    en: 'Remove any local tags that no longer exist on the remote repository, before fetching. Requires Git >= 2.17.0, and "Prune" to be enabled.',
  },
  confirmPruneRemote: {
    zh: '确定要清理远程仓库 {0} 上已不存在的远程跟踪引用吗？',
    en: 'Are you sure you want to prune the remote repository {0} of remote-tracking references that no longer exist?',
  },
  yesPrune: { zh: '是，清理', en: 'Yes, Prune' },
  confirmRemoveIssueLinkingRepo: {
    zh: '确定要移除 Git Graph 中此仓库的 Issue 链接吗？',
    en: 'Are you sure you want to remove the Issue Linking of this repository from Git Graph?',
  },
  confirmRemoveIssueLinkingGlobal: {
    zh: '确定要移除 Git Graph 中全局配置的 Issue 链接吗？',
    en: 'Are you sure you want to remove the globally configured Issue Linking from Git Graph?',
  },
  unableConfigPR: {
    zh: '无法配置"Pull Request 创建"集成',
    en: 'Unable to Configure "Pull Request Creation" Integration',
  },
  mustHaveRemote: {
    zh: '仓库必须至少有一个远程仓库才能配置"Pull Request 创建"集成。当前仓库没有任何远程仓库。',
    en: 'The repository must have at least one remote repository to configure the "Pull Request Creation" integration. This repository does not have any remote repositories.',
  },
  confirmRemovePR: {
    zh: '确定要移除已配置的"Pull Request 创建"集成吗？',
    en: 'Are you sure you want to remove the configured "Pull Request Creation" integration?',
  },
  exportConfigDesc: {
    zh: '导出 Git Graph 仓库配置将生成一个可提交到此仓库的文件。它允许其他在此仓库中工作的人使用相同的配置。',
    en: 'Exporting the Git Graph repository configuration will generate a file that can be committed to this repository. It allows other people working in this repository to use the same configuration.',
  },
  ...
  noReposFound: {
    zh: 'Git Graph 上次扫描时未在当前工作区中找到 Git 仓库。',
    en: 'Git Graph did not find any Git repositories in the current workspace when it was last scanned.',
  },
  maxDepthSearchPrefix: {
    zh: '如果您的仓库位于打开的工作区文件夹的子文件夹中，请确保已正确设置 Git Graph 设置 "git-graph.maxDepthOfRepoSearch"（阅读',
    en: 'If your repository is located in a subfolder of a workspace folder that is open, please ensure that the Git Graph setting "git-graph.maxDepthOfRepoSearch" is set correctly (read the ',
  },
  ...
  issueLinkingExample: {
    zh: '以下示例将提交消息中的 <b>#123</b> 链接到 <b>https://github.com/mhutchie/repo/issues/123</b>：',
    en: 'The following example links <b>#123</b> in a commit message to <b>https://github.com/mhutchie/repo/issues/123</b>:',
  },
  ...
  issueRegexpInfo: {
    zh: '一个匹配您的 Issue 编号的正则表达式，包含一个或多个捕获组 ( )，将被替换到"Issue URL"中。',
    en: 'A regular expression that matches your issue numbers, containing one or more capture groups ( ), to be substituted into the "Issue URL".',
  },
  issueUrlInfo: {
    zh: '您的 Issue 跟踪系统中 Issue 的 URL，包含占位符（$1、$2 等），用于"Issue 正则"中捕获的组 ( )。',
    en: 'The URL of the issue in your issue tracker, containing placeholders ($1, $2, etc.) for the capture groups ( ) in the "Issue Regexp".',
  },
  issueUseGloballyInfo: {
    zh: '默认对所有仓库使用此"Issue 正则"和"Issue URL"（可按仓库覆盖）。注意："全局使用"仅适用于大多数仓库使用相同 Issue 链接的情况（例如使用 JIRA 或 Pivotal Tracker 时）。',
    en: 'Use this "Issue Regexp" and "Issue URL" globally for all repositories by default (can be overridden per repository). Note: "Use Globally" is only recommended if most repositories use the same Issue Linking (e.g. when using JIRA or Pivotal Tracker).',
  },
  issuePrefilledDetected: {
    zh: '<i>预填的 Issue 正则表达式是在此仓库的提交消息中检测到的。如有必要请审查和/或更正。</i>',
    en: "<i>The pre-filled Issue Regular Expression was detected in this repository's commit messages. Please review and/or correct it if necessary.</i>",
  },
  invalidIssueRegexp: { zh: '无效的 Issue 正则', en: 'Invalid Issue Regexp' },
  invalidIssueRegexpNoCapture: {
    zh: '该正则表达式不包含捕获组 ( )。',
    en: 'This regular expression does not contain a capture group ( ).',
  },
  invalidIssueUrl: { zh: '无效的 Issue URL', en: 'Invalid Issue URL' },
  invalidIssueUrlNoPlaceholder: {
    zh: 'Issue URL 不包含用于 Issue 正则中捕获的 Issue 编号组件的任何占位符（$1、$2 等）。',
    en: 'The Issue URL does not contain any placeholders ($1, $2, etc.) for the issue number components captured in the Issue Regexp.',
  },

  // === Pull Request Integration Dialog ===
  prConfigStep1: {
    zh: '配置"Pull Request 创建"集成（步骤&nbsp;1/2）',
    en: 'Configure "Pull Request Creation" Integration (Step&nbsp;1/2)',
  },
  prConfigStep2: {
    zh: '配置"Pull Request 创建"集成（步骤&nbsp;2/2）',
    en: 'Configure "Pull Request Creation" Integration (Step&nbsp;2/2)',
  },
  prProvider: { zh: '提供商', en: 'Provider' },
  prProviderInfo: {
    zh: '除了内置的公开托管的 Pull Request 提供商外，还可以使用扩展设置"git-graph.customPullRequestProviders"配置自定义提供商（例如用于私有托管的 Pull Request 提供商）。',
    en: 'In addition to the built-in publicly hosted Pull Request providers, custom providers can be configured via the "git-graph.customPullRequestProviders" extension setting (e.g. for privately hosted Pull Request providers).',
  },
  prSourceRemote: { zh: '源远程仓库', en: 'Source Remote' },
  prSourceRemoteInfo: {
    zh: '对应于 Pull Request 源的远程仓库。',
    en: 'The remote repository corresponding to the source of the Pull Request.',
  },
  prDestRemote: { zh: '目标远程仓库', en: 'Destination Remote' },
  prDestRemoteInfo: {
    zh: '对应于 Pull Request 目标/目的地的远程仓库。',
    en: 'The remote repository corresponding to the destination of the Pull Request.',
  },
  prHostRootUrl: { zh: '主机根 URL', en: 'Host Root URL' },
  prHostRootUrlInfo: {
    zh: 'Pull Request 提供商的主机根 URL（例如 https://github.com）。',
    en: 'The host root URL of the Pull Request provider (e.g. https://github.com).',
  },
  prSourceOwner: { zh: '源所有者', en: 'Source Owner' },
  prSourceOwnerInfo: {
    zh: 'Pull Request 源仓库的所有者。',
    en: "The owner of the Pull Request's source repository.",
  },
  prSourceRepo: { zh: '源仓库', en: 'Source Repo' },
  prSourceRepoInfo: {
    zh: 'Pull Request 源仓库的名称。',
    en: "The name of the Pull Request's source repository.",
  },
  prDestOwner: { zh: '目标所有者', en: 'Destination Owner' },
  prDestOwnerInfo: {
    zh: 'Pull Request 目标/目的地仓库的所有者。',
    en: "The owner of the Pull Request's destination repository.",
  },
  prDestRepo: { zh: '目标仓库', en: 'Destination Repo' },
  prDestRepoInfo: {
    zh: 'Pull Request 目标/目的地仓库的名称。',
    en: "The name of the Pull Request's destination repository.",
  },
  prDestProjectId: { zh: '目标项目 ID', en: 'Destination Project ID' },
  prDestProjectIdInfo: {
    zh: 'Pull Request 目标/目的地的 GitLab 项目 ID。留空则使用 GitLab 中配置的默认目标/目的地。',
    en: "The GitLab Project ID of the Pull Request's destination. Leave blank to use the default destination configured in GitLab.",
  },
  prDestBranch: { zh: '目标分支', en: 'Destination Branch' },
  prDestBranchInfo: {
    zh: 'Pull Request 目标/目的地的分支名称。',
    en: 'The name of the branch at the destination of the Pull Request.',
  },
 ...
 */
export function initI18n(language: string, vscodeLanguage?: string) {
